...
INSERT INTO customer_accounts (customer_name, password, phone_number, email)
...
UNION ALL
SELECT employee_id, name, NULL AS phone_number, NULL AS email FROM employee_accounts;
